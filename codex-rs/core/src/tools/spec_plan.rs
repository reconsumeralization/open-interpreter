...
fn add_core_tool_sources(context: &CoreToolPlanContext<'_>, registry: &mut ToolRegistry) {
    ...
    add_harness_alias_tools(context, registry);
    add_mcp_resource_tools(context, registry);
    add_core_utility_tools(context, registry);
    add_collaboration_tools(context, registry);
}

fn add_harness_alias_tools(context: &CoreToolPlanContext<'_>, registry: &mut ToolRegistry) {
    let harness = Harness::from_config_name(context.turn_context.config.harness.as_deref());
    if matches!(harness, Harness::Native) {
        return;
    }

    let hidden = ToolExposure::Hidden;
    if harness.is_claude_code() {
        registry.add(HarnessAliasHandler::Agent);
        registry.add_with_exposure(HarnessAliasHandler::TaskOutput, hidden);
        registry.add_with_exposure(HarnessAliasHandler::TaskStop, hidden);
    }
    registry.add(HarnessAliasHandler::Bash);
    registry.add(HarnessAliasHandler::BashLower);
    registry.add(HarnessAliasHandler::Read);
    registry.add(HarnessAliasHandler::ReadLower);
    registry.add(HarnessAliasHandler::Write);
    registry.add(HarnessAliasHandler::WriteLower);
    registry.add(HarnessAliasHandler::Edit);
    registry.add(HarnessAliasHandler::EditLower);
    registry.add(HarnessAliasHandler::Glob);
    registry.add(HarnessAliasHandler::GlobLower);
    registry.add(HarnessAliasHandler::Grep);
    registry.add(HarnessAliasHandler::GrepLower);
    registry.add(HarnessAliasHandler::AskUserQuestion);

    if matches!(harness, Harness::KimiCode) {
        registry.add_with_exposure(HarnessAliasHandler::Agent, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ReadMediaFile, hidden);
        registry.add_with_exposure(HarnessAliasHandler::TaskList, hidden);
        registry.add_with_exposure(HarnessAliasHandler::TaskOutput, hidden);
        registry.add_with_exposure(HarnessAliasHandler::TaskStop, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeEnterPlanMode, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeExitPlanMode, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeSkill, hidden);
        registry.add_with_exposure(KimiCodeAliasHandler::CreateGoal, hidden);
        registry.add_with_exposure(KimiCodeAliasHandler::GetGoal, hidden);
        registry.add_with_exposure(KimiCodeAliasHandler::SetGoalBudget, hidden);
        registry.add_with_exposure(KimiCodeAliasHandler::TodoList, hidden);
        registry.add_with_exposure(KimiCodeAliasHandler::UpdateGoal, hidden);
        registry.add_with_exposure(KimiCodeCronHandler::Create, hidden);
        registry.add_with_exposure(KimiCodeCronHandler::Delete, hidden);
        registry.add_with_exposure(KimiCodeCronHandler::List, hidden);
        registry.add_with_exposure(KimiCodeExtraHandler::AgentSwarm, hidden);
        registry.add_with_exposure(KimiCodeExtraHandler::FetchUrl, hidden);
    }
    if matches!(harness, Harness::DeepSeekTui) {
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekApplyPatch, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ChecklistAdd, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ChecklistList, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ChecklistUpdate, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ChecklistWrite, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekDiagnostics, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekEditFile, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekExecShell, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekFileSearch, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekGitDiff, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekGitStatus, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekGrepFiles, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekListDir, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekReadFile, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekToolSearch, hidden);
        registry.add_with_exposure(HarnessAliasHandler::DeepSeekWriteFile, hidden);
    }
    if matches!(harness, Harness::OpenCode) {
        registry.add_with_exposure(HarnessAliasHandler::OpenCodeTask, hidden);
        registry.add_with_exposure(HarnessAliasHandler::OpenCodeTodoWrite, hidden);
    }
    if matches!(harness, Harness::ZCode) {
        registry.add_with_exposure(HarnessAliasHandler::Agent, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeTodoRead, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeTodoWrite, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeEnterPlanMode, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeExitPlanMode, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeReadSessionContext, hidden);
        registry.add_with_exposure(HarnessAliasHandler::ZCodeSkill, hidden);
    }
}
