...
impl AuthModeWidget {
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        ...
        docs_line.push_span(docs_label.underlined(), Some(docs_url));
        ...
        let lines = vec![
            ...
            "".into(),
            HyperlinkLine::new(chatgpt_success_autonomy_copy(product).into()),
            docs_line,
            "".into(),
            HyperlinkLine::new(chatgpt_success_mistakes_copy(product).into()),
            HyperlinkLine::new(
